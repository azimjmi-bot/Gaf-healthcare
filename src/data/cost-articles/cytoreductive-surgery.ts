...
export const cytoreductiveSurgery: CostArticle = {
  ...
  faqs: [
    { q: "What is the cost of cytoreductive surgery in India?", a: "Plan against [INDIA_COST] for CRS as quoted, anaesthesia, stay of [STAY] and specimen pathology. Typical US self-pay is [US_COST]. HIPEC is a neighbouring sheet when named. The final figure is an itemised hospital estimate after records review, not this planning band." },
    ...
    { q: "What does CRS mean?", a: "CRS means cytoreductive surgery — the same family of operations as this sheet. The letters describe removal of visible peritoneal disease, not a standard package. CRS is not automatically CRS + HIPEC; those are different letters, different stays and different cost sheets." },
    { q: "What is HIPEC?", a: "HIPEC is hyperthermic intraperitoneal chemotherapy: heated chemotherapy circulated through the abdomen after cytoreduction in selected patients. It is not universally used, is not a menu upgrade, and does not guarantee cancer control. Drug, duration and temperature are a clinical protocol." },
    { q: "Is CRS the same as CRS + HIPEC?", a: "No. HIPEC adds drugs, circuit time and typically a longer stay. Neighbouring GAF sheet: Cytoreductive Surgery with HIPEC. Do not compare a CRS letter with a HIPEC letter as if they were the same sitting. Ask which one the estimate names before you travel." },
    { q: "Which cancers may be treated with CRS and HIPEC?", a: "Selected colorectal, appendiceal, ovarian and gastric peritoneal disease, and selected pseudomyxoma peritonei, among others. Not every patient with those diagnoses is eligible. Distribution, tumour burden and fitness matter as much as the primary name on the pathology report. This page does not assign a diagnosis." },
    { q: "Who may be considered for CRS/HIPEC?", a: "Patients whose treating team judges that a meaningful cytoreduction looks possible, with acceptable fitness and without unresectable extra-abdominal disease. Selection is multidisciplinary. Extra-abdominal metastases often mean a different conversation. This page does not decide eligibility for a named patient." },
    ...
    { q: "How long does cytoreductive surgery take?", a: "Typically about six to twelve hours, longer when HIPEC is added. Tumour burden and organ resections change theatre time. A limited cytoreduction can be shorter; a complete clearance with several organs is longer. This page does not promise duration for a named patient." },
    { q: "How long is the hospital stay?", a: "Typically [STAY] for CRS as quoted on this sheet. CRS + HIPEC often sits longer on its own sheet. Leaks, ileus or infection extend that. International patients should add hotel days after discharge. This page does not promise a discharge date." },
    { q: "Is HIPEC included in the surgical cost?", a: "Not on this CRS sheet unless the letter names it. Ask whether the quotation is CRS or CRS + HIPEC, and whether the HIPEC drug and circuit are inside. Extra stay after HIPEC is often a different line. Do not assume the neighbouring sheet is bundled here." },
    { q: "What is included in a CRS/HIPEC quotation?", a: "A typical CRS estimate covers the named surgeon, anaesthesia, theatre, quoted nights, routine inpatient medicines and pathology. HIPEC drugs only if named. Confirm organ resections, extra ICU, imaging and what happens if hospitalization runs longer than written. Anything not on the letter is extra until confirmed." },
    { q: "What costs may be additional?", a: "Often: HIPEC if not named, CT or PET-CT, biopsy, molecular tests, systemic chemotherapy, radiation, extra ICU, leak management, transfusion, rehabilitation, hotel, flights, visa-related expenses and attendant living costs. Surgery cost is not total trip cost and is not total cancer treatment cost." },
    { q: "How do I choose a CRS/HIPEC surgeon?", a: "Use listed consultants whose catalog procedures include cytoreductive surgery or CRS + HIPEC, and insist on speaking to the person who would operate. Ask about peritoneal burden and whether HIPEC is actually planned. Placement on this page is not a league table." },
    { q: "How do I choose a hospital?", a: "Choose on the named surgeon, whether the campus actually runs peritoneal lists that week, leak-aware ICU, and the address on the letter. Accreditation on a profile is as published by the hospital. Listing is not a ranking or a volume claim." },
    { q: "Can international patients send records before travelling?", a: "Yes. Submit recent CT or MRI, pathology, chemotherapy dates and prior operative notes so a listed CRS or HIPEC surgeon can say whether CRS, CRS + HIPEC, PIPAC or a non-operative path is honest before you fly. Visa issuance is not guaranteed by that review." },
    { q: "How long should international patients plan to stay in India?", a: "Plan the inpatient [STAY] plus further hotel days until the named surgeon is content you can fly. HIPEC and slow gut recovery lengthen that. Write the visa letter for a possible extra week rather than the shortest quoted stay. Visa issuance itself is not guaranteed." },
  ],
