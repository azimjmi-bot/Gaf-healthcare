...
export const COST_CONTENT_CURATOR: CostAttributionPerson = {
  ...
  affiliations: [
    "Al-Ameen Dental College, Bijapur, Karnataka",
    "Rajiv Gandhi University of Health Sciences (RGUHS), Bengaluru",
  ],
  bio: "Dr. Shabnam Choudhary, BDS, is a dental professional associated with Al-Ameen Dental College, Bijapur, Karnataka. She contributes to the curation and development of medically informative healthcare content, helping ensure that information is structured clearly and presented in a patient-friendly manner.",
...
export const COST_MEDICAL_REVIEWER: CostAttributionPerson = {
  ...
  bio: "Dr. Saffiyyah Chaudhary, BDS, is a dental professional associated with Al-Ameen Dental College, Bijapur, Karnataka. She provides medical review of healthcare content to help ensure that clinical information is accurate, understandable, and appropriately presented for patients and their families.",
