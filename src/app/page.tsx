    ...
    <>
      <JsonLd
        data={{
          ...
          url: SITE_URL,
          description:
            "Named radiation, surgical and medical oncologists, haematologists, cardiac surgeons, cardiologists, bariatric surgeons and cosmetic surgery pathways in India — Delhi NCR, Mumbai, Bengaluru, Chennai and Hyderabad — plus pediatric hematology and pediatric cardiac surgery, with partner hospital costs in USD.",
      ...
      <section className="relative min-h-[100svh] overflow-hidden bg-ink text-ivory">
        ...
        <div className="relative mx-auto flex min-h-[100svh] max-w-7xl flex-col justify-end px-5 pb-16 pt-32 md:px-8 md:pb-24">
          <p className="eyebrow text-gold">Oncology, cardiac, bariatric and cosmetic care · India</p>
          <h1 className="mt-5 max-w-4xl font-heading text-5xl leading-[0.95] md:text-7xl lg:text-[5.25rem]">
            Oncologists and cosmetic surgeons in India. Hospitals. Costs.
          </h1>
          <p className="mt-6 max-w-xl text-base leading-relaxed text-ivory/80 md:text-lg">
            Named medical, radiation and surgical oncologists, haematologists, cardiac surgeons, cardiologists, bariatric surgeons and cosmetic surgery pathways in Delhi NCR, Mumbai,
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 md:px-8 md:py-28">
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          <IndexCard
            ...
            kicker="01"
            title="Doctors"
            body="Radiation, surgical and medical oncologists, haematologists, cardiac surgeons, bariatric surgeons and cosmetic pathways you meet on camera before any deposit."
          />
          <IndexCard
            href="/hospitals"
            kicker="02"
            title="Hospitals"
            body="JCI campuses in Delhi NCR, Mumbai, Bengaluru, Chennai, and Hyderabad — oncology, cardiac, bariatric and cosmetic surgery."
          />
          <IndexCard
            href="/costs"
            kicker="03"
            title="Treatment Cost"
            body="US cash-pay beside partner ranges for radiation, surgery, transplant, cardiology, bariatric and cosmetic surgery."
          />
          <IndexCard
            href="/blogs"
            kicker="04"
