...
export default async function HospitalDetailPage({
  ...
  const pediatricCardiacFaculty = faculty.filter((d) => d.specialtySlug === "pediatric-cardiac-surgery");
  const cardiologyFaculty = faculty.filter((d) => d.specialtySlug === "cardiology");
  const bariatricFaculty = faculty.filter((d) => d.specialtySlug === "bariatric-surgery");
  const cosmeticFaculty = faculty.filter((d) => d.specialtySlug === "cosmetic-surgery");
  const entFaculty = faculty.filter((d) => d.specialtySlug === "ent");
  const gastroFaculty = faculty.filter((d) => d.specialtySlug === "gastroenterology");
  ...
  const pediatricOrthopaedicFaculty = faculty.filter((d) => d.specialtySlug === "pediatric-orthopaedic");
  const orthopedicsFaculty = faculty.filter((d) => d.specialtySlug === "orthopedics");
  ...
  const nephrologyFaculty = faculty.filter((d) => d.specialtySlug === "nephrology");
  ...
  const pediatricCardiacPathways = pathways.filter((t) => treatmentMatchesSpecialty(t, "pediatric-cardiac-surgery"));
  const cardiologyPathways = pathways.filter((t) => treatmentMatchesSpecialty(t, "cardiology"));
  const bariatricPathways = pathways.filter((t) => treatmentMatchesSpecialty(t, "bariatric-surgery"));
  const cosmeticPathways = pathways.filter((t) => treatmentMatchesSpecialty(t, "cosmetic-surgery"));
  const entPathways = pathways.filter((t) => treatmentMatchesSpecialty(t, "ent"));
  const gastroPathways = pathways.filter((t) => treatmentMatchesSpecialty(t, "gastroenterology"));
  ...
  const pediatricOrthopaedicPathways = pathways.filter((t) => treatmentMatchesSpecialty(t, "pediatric-orthopaedic"));
  const orthopedicsPathways = pathways.filter((t) => treatmentMatchesSpecialty(t, "orthopedics"));
  ...
  const nephrologyPathways = pathways.filter((t) => treatmentMatchesSpecialty(t, "nephrology"));
    ...
    <>
        ...
        <div className="mx-auto max-w-7xl px-5 md:px-8">
          ...
          {faculty.length === 0 ? (
            ...
            <>
              ...
              {pediatricCardiacFaculty.length > 0 ? (
                <div className="mt-10">
                  <h3 className="font-heading text-2xl">Pediatric cardiac surgeons</h3>
                  <div className="mt-6 grid gap-6">
                    {pediatricCardiacFaculty.map((d) => (
                      <DoctorCard key={d.slug} doctor={d} />
                    ))}
                  </div>
                </div>
              ) : null}
              {cardiologyFaculty.length > 0 ? (
                <div className="mt-10">
                  <h3 className="font-heading text-2xl">Cardiologists</h3>
                  <div className="mt-6 grid gap-6">
                    {cardiologyFaculty.map((d) => (
                      <DoctorCard key={d.slug} doctor={d} />
                    ))}
                  </div>
                </div>
              ) : null}
              {bariatricFaculty.length > 0 ? (
                <div className="mt-10">
                  <h3 className="font-heading text-2xl">Bariatric surgeons</h3>
                  <div className="mt-6 grid gap-6">
                    {bariatricFaculty.map((d) => (
                      <DoctorCard key={d.slug} doctor={d} />
                    ))}
                  </div>
                </div>
              ) : null}
              {cosmeticFaculty.length > 0 ? (
                <div className="mt-10">
                  <h3 className="font-heading text-2xl">Cosmetic surgeons</h3>
                  <div className="mt-6 grid gap-6">
                    {cosmeticFaculty.map((d) => (
                      <DoctorCard key={d.slug} doctor={d} />
                    ))}
                  </div>
                </div>
              ...
              {entFaculty.length > 0 ? (
                <div className="mt-10">
                  <h3 className="font-heading text-2xl">ENT surgeons</h3>
                  <div className="mt-6 grid gap-6">
                    {entFaculty.map((d) => (
                      <DoctorCard key={d.slug} doctor={d} />
                    ))}
              ...
              {gastroFaculty.length > 0 ? (
                <div className="mt-10">
                  <h3 className="font-heading text-2xl">Gastroenterologists</h3>
                  <div className="mt-6 grid gap-6">
                    {gastroFaculty.map((d) => (
                      <DoctorCard key={d.slug} doctor={d} />
                    ))}
              ...
              {surgicalGastroFaculty.length > 0 ? (
                <div className="mt-10">
                  <h3 className="font-heading text-2xl">Surgical gastroenterologists</h3>
                  <div className="mt-6 grid gap-6">
                    {surgicalGastroFaculty.map((d) => (
                      <DoctorCard key={d.slug} doctor={d} />
                    ))}
                  </div>
                </div>
              ) : null}
              {urologyFaculty.length > 0 ? (
                <div className="mt-10">
                  <h3 className="font-heading text-2xl">Urologists</h3>
                  <div className="mt-6 grid gap-6">
                    {urologyFaculty.map((d) => (
                      <DoctorCard key={d.slug} doctor={d} />
                    ))}
                  </div>
                </div>
              ) : null}
              {spineFaculty.length > 0 ? (
                <div className="mt-10">
                  <h3 className="font-heading text-2xl">Spine surgeons</h3>
                  <div className="mt-6 grid gap-6">
                    {spineFaculty.map((d) => (
                      <DoctorCard key={d.slug} doctor={d} />
                    ))}
              ...
              {pediatricOrthopaedicFaculty.length > 0 ? (
                <div className="mt-10">
                  <h3 className="font-heading text-2xl">Pediatric orthopaedic surgeons</h3>
                  <div className="mt-6 grid gap-6">
                    {pediatricOrthopaedicFaculty.map((d) => (
                      <DoctorCard key={d.slug} doctor={d} />
                    ))}
                  </div>
                </div>
              ) : null}
              {orthopedicsFaculty.length > 0 ? (
                <div className="mt-10">
                  <h3 className="font-heading text-2xl">Orthopaedic surgeons</h3>
                  <div className="mt-6 grid gap-6">
                    {orthopedicsFaculty.map((d) => (
                      <DoctorCard key={d.slug} doctor={d} />
                    ))}
                  </div>
                </div>
              ) : null}
              {ophthalmologyFaculty.length > 0 ? (
                <div className="mt-10">
                  <h3 className="font-heading text-2xl">Ophthalmologists</h3>
                  <div className="mt-6 grid gap-6">
                    {ophthalmologyFaculty.map((d) => (
                      <DoctorCard key={d.slug} doctor={d} />
                    ))}
                  </div>
                </div>
              ) : null}
              {gynecologyFaculty.length > 0 ? (
                <div className="mt-10">
                  <h3 className="font-heading text-2xl">Gynecologists</h3>
                  <div className="mt-6 grid gap-6">
                    {gynecologyFaculty.map((d) => (
                      <DoctorCard key={d.slug} doctor={d} />
                    ))}
                  </div>
                </div>
              ) : null}
              {neurosurgeryFaculty.length > 0 ? (
                <div className="mt-10">
                  <h3 className="font-heading text-2xl">Neurosurgeons</h3>
                  <div className="mt-6 grid gap-6">
                    {neurosurgeryFaculty.map((d) => (
                      <DoctorCard key={d.slug} doctor={d} />
                    ))}
                  </div>
                </div>
              ...
              {nephrologyFaculty.length > 0 ? (
                <div className="mt-10">
                  <h3 className="font-heading text-2xl">Nephrologists</h3>
                  <div className="mt-6 grid gap-6">
                    {nephrologyFaculty.map((d) => (
                      <DoctorCard key={d.slug} doctor={d} />
                    ))}
                  </div>
                </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 md:px-8">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Radiation, surgical, medical-oncology, haematology, cardiac, cardiology, bariatric, cosmetic, ENT, gastroenterology, surgical-gastroenterology, urology, spine, pulmonology, pediatric-orthopaedic, orthopedics, ophthalmology, gynecology and neurosurgery pathways this house can quote — tagged for later pSEO.
        </p>
        ...
        {pediatricCardiacPathways.length > 0 ? (
          <>
            <h3 className="mt-10 font-heading text-2xl">Pediatric Cardiac Surgery</h3>
            <ProcedureGrid hospital={h} rows={pediatricCardiacPathways} />
          </>
        ) : null}
        {cardiologyPathways.length > 0 ? (
          <>
            <h3 className="mt-10 font-heading text-2xl">Cardiology</h3>
            <ProcedureGrid hospital={h} rows={cardiologyPathways} />
          </>
        ) : null}
        {bariatricPathways.length > 0 ? (
          <>
            <h3 className="mt-10 font-heading text-2xl">Bariatric Surgery</h3>
            <ProcedureGrid hospital={h} rows={bariatricPathways} />
          </>
        ) : null}
        {cosmeticPathways.length > 0 ? (
          <>
            <h3 className="mt-10 font-heading text-2xl">Cosmetic Surgery</h3>
            <ProcedureGrid hospital={h} rows={cosmeticPathways} />
          </>
        ) : null}
        {entPathways.length > 0 ? (
          <>
            <h3 className="mt-10 font-heading text-2xl">ENT</h3>
            <ProcedureGrid hospital={h} rows={entPathways} />
          </>
        ) : null}
        {gastroPathways.length > 0 ? (
          <>
            <h3 className="mt-10 font-heading text-2xl">Gastroenterology</h3>
            <ProcedureGrid hospital={h} rows={gastroPathways} />
          </>
        ) : null}
        {surgicalGastroPathways.length > 0 ? (
          <>
            <h3 className="mt-10 font-heading text-2xl">Surgical Gastroenterology</h3>
            <ProcedureGrid hospital={h} rows={surgicalGastroPathways} />
          </>
        ) : null}
        {urologyPathways.length > 0 ? (
          <>
            <h3 className="mt-10 font-heading text-2xl">Urology</h3>
            <ProcedureGrid hospital={h} rows={urologyPathways} />
          </>
        ) : null}
        {spinePathways.length > 0 ? (
          <>
        ...
        {pediatricOrthopaedicPathways.length > 0 ? (
          <>
            <h3 className="mt-10 font-heading text-2xl">Pediatric Orthopaedic</h3>
            <ProcedureGrid hospital={h} rows={pediatricOrthopaedicPathways} />
          </>
        ) : null}
        {orthopedicsPathways.length > 0 ? (
          <>
            <h3 className="mt-10 font-heading text-2xl">Orthopedics</h3>
            <ProcedureGrid hospital={h} rows={orthopedicsPathways} />
          </>
        ) : null}
        {ophthalmologyPathways.length > 0 ? (
          <>
            <h3 className="mt-10 font-heading text-2xl">Ophthalmology</h3>
            <ProcedureGrid hospital={h} rows={ophthalmologyPathways} />
          </>
        ) : null}
        {gynecologyPathways.length > 0 ? (
          <>
            <h3 className="mt-10 font-heading text-2xl">Gynecology</h3>
            <ProcedureGrid hospital={h} rows={gynecologyPathways} />
          </>
        ) : null}
        {neurosurgeryPathways.length > 0 ? (
          <>
        ...
        {nephrologyPathways.length > 0 ? (
          <>
            <h3 className="mt-10 font-heading text-2xl">Nephrology</h3>
            <ProcedureGrid hospital={h} rows={nephrologyPathways} />
          </>
        ) : null}
      </section>
