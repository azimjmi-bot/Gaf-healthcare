  ...
  return (
    <>
      ...
      <PageIntro
        ...
        title={heading}
        lede="JCI and NABH campuses in Delhi NCR, Mumbai, Bengaluru, Chennai and Hyderabad. Each house is filed under country, city, specialty and procedure — Radiation, Surgical and Medical Oncology, plus Hematology — with named consultants where Velora has matched them."
      >
