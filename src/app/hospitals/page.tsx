  ...
  return (
    <>
      ...
      <PageIntro
        ...
        title={heading}
        lede="JCI and NABH campuses in Delhi NCR, Mumbai, Bengaluru, Chennai and Hyderabad. Each house is filed under country, city, specialty and procedure — Radiation, Surgical and Medical Oncology, Hematology, Pediatric Hematology, Cardiac Surgery, Pediatric Cardiac Surgery, Cardiology, Bariatric Surgery, Cosmetic Surgery, ENT, Gastroenterology, Surgical Gastroenterology, Urology, Spine Surgery, Pulmonology, Pediatric Orthopaedic, Orthopedics, Ophthalmology, Gynecology, Neurosurgery, Neurology and Nephrology — with named consultants on those lists, including neurologists for stroke, epilepsy and movement lists, neurosurgeons for brain tumour, aneurysm and radiosurgery, gynecologists for hysterectomy, myomectomy and endometriosis, and ophthalmologists for cataract, LASIK, cornea and retina. Kidney transplantation stays the shared Urology slug; plasmapheresis stays the shared Neurology slug."
      >
