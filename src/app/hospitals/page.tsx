...
export default async function HospitalsPage({
  ...
  const heading = query.procedure
    ...
    : query.specialty
      ...
      : "Oncology, bariatric and cosmetic hospitals in India";
