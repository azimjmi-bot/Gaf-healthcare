  ...
  return (
    <>
      ...
      <PageIntro
        ...
        title={heading}
        lede="JCI and NABH campuses in Delhi NCR, Mumbai, Bengaluru, Chennai and Hyderabad. Each house is filed under country, city, specialty and procedure — Radiation, Surgical and Medical Oncology, Hematology, Pediatric Hematology, Cardiac Surgery, Pediatric Cardiac Surgery, Cardiology, Bariatric Surgery, Cosmetic Surgery, ENT, Gastroenterology, Surgical Gastroenterology, Urology, Spine Surgery, Pulmonology, Pediatric Orthopaedic, Orthopedics, Ophthalmology, Gynecology and Neurosurgery — with named consultants on those lists, including neurosurgeons for brain tumour, aneurysm and radiosurgery, gynecologists for hysterectomy, myomectomy and endometriosis, and ophthalmologists for cataract, LASIK, cornea and retina."
      >
