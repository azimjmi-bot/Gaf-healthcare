...
export function articleCampuses(treatment: Treatment, city?: string) {
  ...
  const requireProcedureTaggedFaculty =
    ...
    treatment.specialtySlug === "hematology" ||
    treatment.specialtySlug === "cardiac-surgery" ||
    treatment.specialtySlugs.includes("bariatric-surgery") ||
    treatment.specialtySlugs.includes("cosmetic-surgery") ||
    treatment.specialtySlugs.includes("cardiology") ||
    treatment.specialtySlugs.includes("ent") ||
    treatment.specialtySlugs.includes("gastroenterology") ||
    treatment.specialtySlugs.includes("surgical-gastroenterology") ||
    treatment.specialtySlugs.includes("neurosurgery") ||
    treatment.specialtySlugs.includes("nephrology") ||
