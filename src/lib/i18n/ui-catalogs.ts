...
const AR: Record<string, string> = {
  ...
  "dir.hospitals.homeLede":
    "استكشف المستشفيات حسب البلد والمدينة والتخصص والعلاج، وقارن المنشآت للعثور على خيارات تناسب احتياجك الطبي.",
  "dir.hospitals.filteredLede":
    "حرم JCI وNABH في دلهي إن سي آر ومومباي وبنغالور وتشيناي وحيدر آباد. يظهر كل مستشفى مرة واحدة. عشرة حرم في الصفحة — التخصصات على البطاقة.",
