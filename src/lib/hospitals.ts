...
const neurosurgery = getSpecialty("Neurosurgery");
const neurology = getSpecialty("Neurology");
const nephrology = getSpecialty("Nephrology");
if (
  !radiation ||
  !surgical ||
  !medical ||
