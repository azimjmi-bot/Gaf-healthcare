...
export function CostArticleView({
  ...
  const isPulmonology = treatment.specialtySlug === "pulmonology";
  const isUrology = treatment.specialtySlug === "urology";
  ...
  return (
    <article className="w-full pb-4 [&_a]:underline-offset-4 [&_a:hover]:underline">
      ...
      <p className="mt-4 text-sm">
        <a href="#clinical-detail" className="underline-offset-4 hover:underline">
          {isNonsurgicalTreatment
            ...
            : isCardiology || isEnt || isGastroenterology
      ...
      {article.costComponents && article.costComponents.length > 0 ? (
        <>
          ...
          <P>
            ...
            typically sits inside a {isNonsurgicalTreatment ? "treatment" : isCardiology ? "cardiac procedure" : isEnt ? "ENT procedure" : isGastroenterology ? "gastroenterology procedure" : "surgical"} estimate,
      ...
      <P>
        ...
        a {isHematology ? "hematology" : isMedicalOncology ? "medical oncology" : isCardiacSurgery || isCardiology ? "cardiac procedure" : isBariatricSurgery ? "bariatric procedure" : isCosmeticSurgery ? "cosmetic procedure" : isEnt ? "ENT" : isGastroenterology ? "gastroenterology" : "surgical"} estimate for this {isNonsurgicalTreatment ? "treatment" : "procedure"}.
      ...
      <P>
        These are the drivers that actually move a bill for this {isNonsurgicalTreatment || isCardiology || isEnt || isGastroenterology ? "procedure" : "operation"}, in rough order of how often
      ...
      {approach ? (
        <>
          ...
          <p className="cost-scroll-hint">
            Swipe to compare {isNonsurgicalTreatment ? "treatment approaches" : isCardiology || isEnt || isGastroenterology ? "procedural approaches" : "surgical approaches"} →
          </p>
          ...
          <p className="mt-3 text-xs leading-relaxed text-muted-foreground">
            ...
            {isNonsurgicalTreatment || isCardiology || isEnt || isGastroenterology ? " procedure" : " operation"}. Other rows describe relative clinical
      ...
      {article.destinationIntro ? (
        ...
        <P>
          The comparison below is for the same {isNonsurgicalTreatment ? "treatment assumption" : isCardiology || isEnt || isGastroenterology ? "procedure assumption" : "operation"} in each market, not for different treatments
      ...
      {article.cityIntro ? (
        ...
        <>
          <P>
            ...
            are walking into. It changes the {isHematology ? "protocol, laboratory and monitoring bill" : isMedicalOncology ? "medicine and monitoring bill" : isCardiology ? "procedure and device bill" : isEnt ? "procedure and implant bill" : isGastroenterology ? "procedure and device bill" : "surgical fee"} far less than patients expect.
          </P>
          <P>
          ...
          treatment.specialtySlug === "spine-surgery"
            ...
            :           treatment.specialtySlug === "pediatric-orthopaedic"
              ...
              : treatment.specialtySlug === "radiation-oncology"
                ...
                : isPulmonology
                  ? "Need a case-specific pulmonology estimate?"
                : isUrology
                  ? "Need a case-specific urology estimate?"
                : isCardiacSurgery
          ...
          treatment.specialtySlug === "spine-surgery"
            ...
            : treatment.specialtySlug === "pediatric-orthopaedic"
              ...
              : treatment.specialtySlug === "radiation-oncology"
                ...
                : isPulmonology
                  ? "Share pulmonology notes, chest X-ray, CT or HRCT images, pulmonary function tests, oxygen requirements, bronchoscopy, pathology and microbiology reports when available. A named respiratory team can then discuss diagnostic or therapeutic intent, technique, sedation, devices, specimen studies, monitoring and a written estimate — this is not a quotation or a treatment decision."
                : isUrology
                  ? "Share urology notes, CT or ultrasound, PSA and MRI prostate, biopsy or histopathology, kidney-function tests, urine culture, uroflowmetry or urodynamics and previous operative reports when available. A named urology team can then discuss indication, endoscopic, laparoscopic, robotic or open approach, stents, catheters or implants, pathology and a written hospital estimate — this is not a quotation or a treatment decision."
                : isCardiacSurgery
          ...
          treatment.specialtySlug === "spine-surgery"
            ...
            : treatment.specialtySlug === "pediatric-orthopaedic"
              ...
              : treatment.specialtySlug === "radiation-oncology"
                ...
                : isPulmonology
                  ? "Speak with GAF Healthcare about pulmonology in India"
                : isUrology
                  ? "Speak with GAF Healthcare about urology in India"
                : isCardiacSurgery
      ...
      <H3>
        {isBariatricSurgery || isCosmeticSurgery || isCardiology || isEnt || isGastroenterology || isSurgicalGastroenterology || isNeurosurgery || isNephrology || isNeurology || isGynecology || isOphthalmology || isPulmonology || isUrology
