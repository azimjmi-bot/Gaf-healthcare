export const batch = {
  title: "Batch 27 — Orthopedics, India",
  intro: `
...
`,
  doctors: [
    {
      slug: "dr-a-h-ashwin-kumar",
      bio: `Dr. A.H. Ashwin Kumar is a Consultant at KIMS Hospitals, Secunderabad, in Hyderabad, with more than 16 years of experience in orthopedics.
...
The other two were best paper awards at conferences. He won the Prof. C. Vyageswaradu Gold Medal in 2010 for "DVT and its Risk Factors in Replacement Surgeries – Our Experience", presented at TNOACON 2010 in Courtallam, and the same medal again in 2012 for "Component Motion in Bipolar Hemiarthroplasty – A Prospective Study", presented at OSSAPCON 2012 in Rajamundry. Both papers are on replacement surgery, the field his special training was in.`,
    ...
    {
      slug: "dr-kushal-shah",
      bio: `Dr. Kushal Shah is a Consultant at Gleneagles Hospital in Mumbai, with more than 13 years of experience. His profile records orthopedics alongside cosmetic and plastic surgery for hand reconstruction and pediatric orthopedics.
...
He has won three conference prizes: best poster at GOSICON 2017 in Bangalore, best e-poster at Oncoorthocon 2018 in Ahmedabad and best paper at ISSHCON 2022 in Jaipur. He practises at Gleneagles Hospital in Parel.`,
    ...
    {
      slug: "dr-jitendra-kataria",
      bio: `Dr. Jitendra Kataria is a Consultant at Gleneagles Hospital in Mumbai, with more than 10 years of experience. His profile records orthopedics alongside pediatric orthopedics and spine surgery.
...
He is at Gleneagles Hospital in Parel, and his record lists P. D. Hinduja Hospital and Research Centre and KIMS Karad as training affiliations, along with clinical practice at leading hospitals and surgical centers in Mumbai. Five qualifications and three specializations against ten years in practice make for a dense record for the stage of career it describes.`,
    ...
    {
      slug: "dr-bejjanki-nithin-kumar",
      bio: `Dr. Bejjanki Nithin Kumar is a Senior Consultant at Yashoda Hospitals, Secunderabad, in Hyderabad, with more than 25 years of experience. His profile records orthopedics together with sports medicine.
...
Alongside Yashoda Hospital in Secunderabad he has been at Continental Hospitals in Hyderabad.`,
    ...
    {
      slug: "dr-prof-amit-kumar-agarwal",
      bio: `Dr. Prof Amit Kumar Agarwal is a Senior Consultant Orthopedic Surgeon at Indraprastha Apollo Hospital in the Delhi NCR, with more than 22 years of experience in orthopedics.
