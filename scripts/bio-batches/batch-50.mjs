export const batch = {
  title: "Batch 50 — Pulmonology, India",
  intro: `
...
`,
  doctors: [
    {
      slug: "dr-manas-mengar",
      bio: `Dr. Manas Mengar is a Senior Consultant at KIMS Hospitals, Thane, in Mumbai, with more than 10 years of experience in pulmonology.
...
He was faculty on the advisory board at Medsicon 2019 and has several publications in national and international medical journals. He practises at KIMS Hospital in Thane.`,
    },
    {
      ...
      bio: `Dr. Priya Sharma is a Consultant at Sarvodaya Hospital, Faridabad, in Delhi NCR, with more than 13 years of experience in pulmonology.
...
She is a member of the European Respiratory Society, the Indian Chest Society and the National Academy of Medical Sciences. Alongside Sarvodaya Hospital in Sector 8, Faridabad, she has been affiliated with Indraprastha Apollo Hospital in Delhi and Kalpana Chawla Government Medical College in Karnal.`,
    ...
    {
      slug: "dr-lakshminarayana-jasti",
      bio: `Dr. Lakshminarayana Jasti is Lead Consultant and Course Director of the Interventional Pulmonology Fellowship Program at KIMS Hospitals, Secunderabad, in Hyderabad, with more than 10 years of experience.
...
He is a life member of the Indian Chest Society and a member of the European Respiratory Society.`,
    ...
    {
      slug: "dr-nandani-gulati",
      bio: `Dr. Nandani Gulati is a Senior Consultant at Fortis Memorial Research Institute in Delhi NCR, with more than 10 years of experience in pulmonology.
...
Her presentations run from 2014 onward: the Asia Pacific Society of Respirology Congress and NAPCON in November 2014, the Indian Radiology and Imaging Association conference in January 2015, and IPF Medicon in 2019. She won a best paper award at ICONIC in Pune in February 2014 and third prize for a poster on non-resolving pneumonia at the 17th Critical Care Symposium in 2022. She practises at Fortis Hospital in Vasant Kunj.`,
    ...
    {
      slug: "dr-v-pratibh-prasad",
      bio: `Dr. V Pratibh Prasad is a Consultant Clinical and Interventional Pulmonologist at Yashoda Hospitals, Hi-Tech City, in Hyderabad, with more than 10 years of experience. His profile records pulmonology together with interventional pulmonology and paediatric pulmonology.
...
His memberships cover the field in India and abroad: the Indian Chest Society, the National College of Chest Physicians, the Indian Association of Bronchology, the European Respiratory Society, the American College of Chest Physicians and the Asia Pacific Society of Respirology.`,
    ...
    {
      slug: "dr-sridhar-r",
      bio: `Dr. Sridhar R is an Interventional Pulmonologist at MGM Healthcare in Chennai, with more than 10 years of experience. His profile records pulmonology together with lung cancer diagnosis and staging.
...
He practises at MGM Healthcare in Chennai, having trained at Apollo Hospitals in the same city.`,
    ...
    {
      slug: "dr-s-suresh-sagadevan",
      bio: `Dr. S Suresh Sagadevan is Clinical Lead and Consultant at Gleneagles HealthCity Chennai, with more than 10 years of experience. His profile records pulmonology together with interventional pulmonology, sleep medicine and pre- and post-transplant care for lung transplantation.
...
Pre- and post-transplant care being named on his profile alongside interventional pulmonology means his involvement in transplantation covers the assessment and follow-up around the operation rather than the surgery itself. He practises at Gleneagles Global Health City in Chennai.`,
    ...
    {
      slug: "dr-jayaraman-s",
      bio: `Dr. Jayaraman S is a Senior Consultant at MGM Healthcare in Chennai, with more than 20 years of experience in pulmonology.
...
A diploma in tuberculosis and chest diseases taken in Chennai, an American fellowship five years later, and two decades of practice since describe a physician whose training began with tuberculosis at a time when it dominated the specialty, and whose list still carries both its resistant and its late forms. He practises at MGM Healthcare in Chennai.`,
    ...
    {
      slug: "dr-gargi-maitra",
      bio: `Dr. Gargi Maitra is a Senior Consultant at Fortis Memorial Research Institute in Delhi NCR, with more than 15 years of experience in pulmonology.
...
She practises at Fortis Memorial Research Institute in Gurugram.`,
    ...
    {
      slug: "dr-chandrakanth-tarke",
      bio: `Dr. Chandrakant Tarke is a Consultant at Apollo Hospital, Jubilee Hills, in Hyderabad, with more than 11 years of experience in pulmonology.
...
Taking both a research paper prize and a national quiz at the same conference is unusual, since the two test very different things. He practises at Apollo Health City in Jubilee Hills.`,
    ...
    {
      slug: "dr-deepika-ramachandran",
      bio: `Dr. Deepika Ramachandran is a Consultant at MGM Healthcare in Chennai, with more than 7 years of experience in pulmonology.
...
She has research presentations and publications at national and international forums, and serves as faculty, presenter, panelist and workshop moderator at major pulmonology conferences. She practises at MGM Healthcare in Chennai.`,
    ...
    {
      slug: "dr-sreenivasan-v",
      bio: `Dr. Sreenivasan V is a Consultant in the Department of Pulmonary Critical Care and Lung Transplantation at Gleneagles HealthCity Chennai, with more than 18 years of experience. His profile records pulmonology together with interventional pulmonology and sleep medicine.
